  ...
  data () {
    ...
    return {
      ...
      text: [
        ...
        '很久没点开超话了……前两天看到一个歌迷朋友剪辑了一个15年前视频，那时的我，呃，确实还不是一个能自洽的我……但幸好会唱歌一点，让我遇见了这么棒的你们……今天这个日子，想点一首歌，送给一直陪伴我的星星们。这18年里，我们一起成长，彼此鼓励，努力成为更好的人。很开心，也很幸运有你们一路陪伴，我继续唱歌给你们听，《然后我们成了想成为的人》送给你们！',
        '这个人真的好可恶呀！',
