...
# pyright: reportAttributeAccessIssue=false, reportIncompatibleMethodOverride=false, reportCallIssue=false, reportOperatorIssue=false, reportGeneralTypeIssues=false
...
class BooleanFieldListFilter(ListFieldFilter):
    ...
    @classmethod
    def test(cls, field, request, params, model, admin_view, field_path):
        return isinstance(field, (models.BooleanField, models.BooleanField))
