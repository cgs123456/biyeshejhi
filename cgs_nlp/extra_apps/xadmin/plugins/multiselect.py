...
class SelectMultipleTransfer(forms.SelectMultiple):
    ...
    def render(self, name, value, attrs=None, renderer=None, choices=()):
        ...
        for option_value, option_label in chain(list(self.choices), list(choices)):
...
class SelectMultipleDropdown(forms.SelectMultiple):
    ...
    def render(self, name, value, attrs=None, renderer=None, choices=()):
        ...
        return super(SelectMultipleDropdown, self).render(name, value, attrs, renderer=renderer)
