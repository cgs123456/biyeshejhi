# coding=utf-8
# pyright: reportAttributeAccessIssue=false, reportIncompatibleMethodOverride=false, reportOptionalMemberAccess=false, reportGeneralTypeIssues=false
...
class PermissionAdmin(object):
    ...
    setattr(show_name, "short_description", _('Permission Name'))
    setattr(show_name, "is_column", True)
...
class ChangePasswordView(ModelAdminView):
    ...
    def post(self, request, object_id):
        ...
        if self.form.is_valid():
            ...
            return HttpResponseRedirect(self.model_admin_url('change', cast(Any, self.obj).pk))
        else:
            return self.get_response()
