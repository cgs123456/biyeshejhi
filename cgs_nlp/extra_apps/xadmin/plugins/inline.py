# pyright: reportAttributeAccessIssue=false, reportIncompatibleMethodOverride=false, reportGeneralTypeIssues=false, reportOptionalCall=false
import copy
import inspect
...
from xadmin.layout import FormHelper, flatatt, Container, Fieldset
...
class DeleteField(Field):
    ...
    def render(self, form, form_style, context, template_pack=TEMPLATE_PACK, **kwargs):
        if form.instance.pk:
            ...
            return super(DeleteField, self).render(form, form_style, context, template_pack, **kwargs)
        else:
            return ""
