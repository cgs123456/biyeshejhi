...
# pyright: reportAttributeAccessIssue=false, reportIncompatibleMethodOverride=false, reportFunctionMemberAccess=false, reportArgumentType=false, reportCallIssue=false, reportGeneralTypeIssues=false, reportOptionalMemberAccess=false, reportOptionalSubscript=false
import copy
...
from xadmin.layout import FormHelper, Fieldset, Container, Col
...
class FormAdminView(CommAdminView):
    ...
    def instance_forms(self):
        form_data = self.get_form_datas()
        self.form_obj = self.view_form(data=form_data.get('data'),
